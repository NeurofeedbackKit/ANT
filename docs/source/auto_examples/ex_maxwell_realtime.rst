...
.. "auto_examples/ex_maxwell_realtime.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_ex_maxwell_realtime.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_ex_maxwell_realtime.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 84-156
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/payamsadeghishabestari/ANT/examples/ex_maxwell_realtime.py:242: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
      fig1.tight_layout()
...
.. GENERATED FROM PYTHON SOURCE LINES 247-281
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_maxwell_realtime_002.png
   :alt: Full range 1–100 Hz, Close-up 1–40 Hz
   :srcset: /auto_examples/images/sphx_glr_ex_maxwell_realtime_002.png
   :class: sphx-glr-single-img
...
.. GENERATED FROM PYTHON SOURCE LINES 284-304
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_maxwell_realtime_003.png
   :alt: Per-chunk LSL latency  ·  59 chunks (get_data + RTMaxwellFilter.transform)
   :srcset: /auto_examples/images/sphx_glr_ex_maxwell_realtime_003.png
   :class: sphx-glr-single-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: ex_maxwell_realtime.ipynb <ex_maxwell_realtime.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: ex_maxwell_realtime.py <ex_maxwell_realtime.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: ex_maxwell_realtime.zip <ex_maxwell_realtime.zip>`
