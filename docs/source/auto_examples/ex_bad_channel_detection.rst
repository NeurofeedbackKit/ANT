...
.. "auto_examples/ex_bad_channel_detection.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_ex_bad_channel_detection.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_ex_bad_channel_detection.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 102-152
...
.. GENERATED FROM PYTHON SOURCE LINES 167-200
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_bad_channel_detection_001.png
   :alt: ex bad channel detection
   :srcset: /auto_examples/images/sphx_glr_ex_bad_channel_detection_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/payamsadeghishabestari/ANT/examples/ex_bad_channel_detection.py:200: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
      fig1.tight_layout()
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: ex_bad_channel_detection.ipynb <ex_bad_channel_detection.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: ex_bad_channel_detection.py <ex_bad_channel_detection.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: ex_bad_channel_detection.zip <ex_bad_channel_detection.zip>`
