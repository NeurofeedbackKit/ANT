...
.. "auto_examples/ex_complete_nf_session.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_ex_complete_nf_session.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_ex_complete_nf_session.py:
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
      ...
      [nf_data ] → /Users/payamsadeghishabestari/ANT_session_results/subjects/sub-sub01/ses-01/beh/sub-sub01_ses-01_task-neurofeedback_beh.json
      [nf_tsv  ] → /Users/payamsadeghishabestari/ANT_session_results/subjects/sub-sub01/ses-01/beh/sub-sub01_ses-01_task-neurofeedback_beh.tsv
      [report  ] → /Users/payamsadeghishabestari/ANT_session_results/subjects/sub-sub01/ses-01/reports/sub-sub01_ses-01_report.html
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
      ...
      [BIDS    ] → /Users/payamsadeghishabestari/ANT_session_results/bids
      .DS_Store
      ...
      sub-sub01
        ...
        ses-main
          .DS_Store
          beh
            sub-sub01_ses-main_task-neurofeedback_beh.tsv
          eeg
            sub-sub01_ses-main_task-neurofeedback_eeg.fif
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_complete_nf_session_001.png
   :alt: NF feature time-series — 100 s session with 10 s on/off alpha bursts, Sensor power  (V²/Hz), ERD/ERS  (%), Alpha laterality  (a.u.), Spectral centroid  (Hz)
   :srcset: /auto_examples/images/sphx_glr_ex_complete_nf_session_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/payamsadeghishabestari/ANT/examples/ex_complete_nf_session.py:257: UserWarning: The figure layout has changed to tight
      plt.tight_layout()
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (2 minutes 17.615 seconds)


.. _sphx_glr_download_auto_examples_ex_complete_nf_session.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: ex_complete_nf_session.ipynb <ex_complete_nf_session.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: ex_complete_nf_session.py <ex_complete_nf_session.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: ex_complete_nf_session.zip <ex_complete_nf_session.zip>`
