...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_ex_erp_plots.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_ex_erp_plots.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 95-127
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Callback latency: mean=0.08 ms  max=0.71 ms
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_erp_plots_001.png
   :alt: Real-time ERP accumulation — EEG 021
   :srcset: /auto_examples/images/sphx_glr_ex_erp_plots_001.png
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/payamsadeghishabestari/ANT/examples/ex_erp_plots.py:157: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
      f.tight_layout()
    /Users/payamsadeghishabestari/ANT/examples/ex_erp_plots.py:157: UserWarning: The figure layout has changed to tight
      f.tight_layout()
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_erp_plots_002.png
   :alt: Single-trial epochs — EEG 021, µV
   :srcset: /auto_examples/images/sphx_glr_ex_erp_plots_002.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 4.522 seconds)


.. _sphx_glr_download_auto_examples_ex_erp_plots.py:
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: ex_erp_plots.ipynb <ex_erp_plots.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: ex_erp_plots.py <ex_erp_plots.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: ex_erp_plots.zip <ex_erp_plots.zip>`
