...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    RT-SSS applied over 59 chunks of 601 samples each
...
.. GENERATED FROM PYTHON SOURCE LINES 154-212
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    LSL streaming section skipped: mne_lsl is mocked
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_maxwell_realtime_001.png
   :alt: RT-SSS vs. Offline SSS — Time Series MNE Sample MEG (chunk-by-chunk comparison), Channel: MEG 0111, Channel: MEG 0121, Channel: MEG 0131, Residual (Offline − RT-SSS) | RMS Error = 0.170 aT
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/payamsadeghishabestari/ANT/examples/plot_maxwell_realtime.py:272: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
      fig1.tight_layout()
...
.. GENERATED FROM PYTHON SOURCE LINES 277-319
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_maxwell_realtime_002.png
   :alt: PSD Comparison — Raw / Offline SSS / RT-SSS, Full range 1–100 Hz, Close-up 1–40 Hz
...
.. GENERATED FROM PYTHON SOURCE LINES 326-371
...
.. image-sg:: /auto_examples/images/sphx_glr_plot_maxwell_realtime_003.png
   :alt: Per-channel Correlation (chunk-by-chunk) and LSL Streaming Latency, Offline vs. RT-SSS mean r = 1.000000, Per-chunk LSL latency (get_data + RTMaxwellFilter.transform)  ·  0 chunks
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/payamsadeghishabestari/ANT/examples/plot_maxwell_realtime.py:370: UserWarning: This figure includes Axes that are not compatible with tight_layout, so results might be incorrect.
      fig3.tight_layout()
