...
.. "auto_examples/ex_motor_imagery_nf.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_ex_motor_imagery_nf.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_ex_motor_imagery_nf.py:
...
.. GENERATED FROM PYTHON SOURCE LINES 174-226
...
.. GENERATED FROM PYTHON SOURCE LINES 229-280
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_motor_imagery_nf_001.png
   :alt: ERD/ERS (8–30 Hz band) vs. pre-cue baseline , Left imagery — C3 ERD = blue  (dB re baseline), Right imagery — C4 ERD = blue  (dB re baseline), Right imagery — C3 ERD = blue  (dB re baseline)
   :srcset: /auto_examples/images/sphx_glr_ex_motor_imagery_nf_001.png
...
.. image-sg:: /auto_examples/images/sphx_glr_ex_motor_imagery_nf_002.png
   :alt: Laterality stream and reward events, Laterality distribution
   :srcset: /auto_examples/images/sphx_glr_ex_motor_imagery_nf_002.png
   :class: sphx-glr-single-img
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-jupyter
      ...
      :download:`Download Jupyter notebook: ex_motor_imagery_nf.ipynb <ex_motor_imagery_nf.ipynb>`

    .. container:: sphx-glr-download sphx-glr-download-python

      :download:`Download Python source code: ex_motor_imagery_nf.py <ex_motor_imagery_nf.py>`

    .. container:: sphx-glr-download sphx-glr-download-zip

      :download:`Download zipped: ex_motor_imagery_nf.zip <ex_motor_imagery_nf.zip>`
